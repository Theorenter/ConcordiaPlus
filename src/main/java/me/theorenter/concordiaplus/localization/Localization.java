package me.theorenter.concordiaplus.localization;
...
public final class Localization {
    ...
    public Localization(@NotNull final Plugin plugin,
        ...
        //if (isClientOriented) {
        //  plugin.getServer().getPluginManager().registerEvents(new LocalizationListener(plugin, this), plugin);
        //}
    }
    ...
    public Component get(@NotNull final String key, @NotNull final Locale localeTag, @NotNull String... placeholders) {
        ...
        try {
            text = MessageFormat.format(text, placeholders);
        } catch (IllegalArgumentException ex) {
    ...
    public LocalizationBundle getReferenceBundle(String localeTag) {
        return REFERENCE_LOCALIZATION_MAP.get(localeTag);
    }

    public LocalizationBundle getOverrideBundle(String localeTag) {
        return OVERRIDE_LOCALIZATION_MAP.get(localeTag);
    }
}